...
class Astoundify_EDD_VPI {
	...
	public function download_price_table_head() {
		echo '<th style="width: 100px;">' . __( 'Preview', 'edd_vpi' ) . '</th>';
	}

	public function download_price_table_row( $post_id, $key, $args ) {
		?>
			<td>
				<a href="#" class="edd_vpi_assign button-secondary" style="margin: 3px 0 0"><?php _e( 'Assign Image', 'edd_vpi' ); ?></a>
				<input type="hidden" name="edd_variable_prices[<?php echo esc_attr( $key ); ?>][image]" value="" />
			</td>
		<?php
	}
